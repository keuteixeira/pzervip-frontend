 ...
 *
 * Tamanho máximo de imagem: alinhar com backend `IMAGE_UPLOAD_MAX_KB` (quilobytes) e texto em register-media.
 */
export const REGISTER_IMAGE_MAX_FILE_MB = 20 as const
...
export const REGISTER_COVER = {
  ...
  maxFileMb: REGISTER_IMAGE_MAX_FILE_MB,
  formatsHint: 'JPG, PNG ou WebP.',
} as const

/** Proporção do recorte do banner (igual à sugerida na listagem / capa). */
export const REGISTER_COVER_ASPECT_RATIO =
